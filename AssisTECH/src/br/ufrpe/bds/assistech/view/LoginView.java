...
public class LoginView extends View {
	...
	private void initComponents() {
		setTitle("Assistech - area de Acesso");
		...
		this.addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent evt) {
				int resposta = JOptionPane.showConfirmDialog(null, "Deseja fechar a aplicacao?", "Sair da aplicacao.", JOptionPane.YES_NO_OPTION);
